...
#include "OpenGlExtensions.core.h"
...
bool EAE_Engine::OpenGlExtensions::LoadCore( std::string* o_errorMessage )
{
...
#define EAE_ENGINE_LOADGLFUNCTION( i_functionName, i_functionType )														\
		...
		if ( !i_functionName )																							\
			return false;
/*
	//EAE_ENGINE_LOADGLFUNCTION(glGetError, PFNGLGETERRORPROC);
	...
	EAE_ENGINE_LOADGLFUNCTION(glEnableVertexAttribArray, PFNGLENABLEVERTEXATTRIBARRAYPROC);
